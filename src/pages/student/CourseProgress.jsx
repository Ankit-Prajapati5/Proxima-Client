...
const CourseProgress = () => {
  ...
  if (isError || !data)
    return <div className="text-center pt-20">Failed to load progress.</div>;
  ...
  const nextLecture =
    currentIndex !== -1 && currentIndex < totalLectures - 1
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-500">
            Track your learning journey and resume where you left off.
          </p>
        </div>
      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-6 rounded-2xl shadow-sm mb-8">
        ...
        {nextLecture && (
          ...
          >
            ...
            {completedCount === 0
              ? "Start Learning"
              : "Continue: " + nextLecture.lectureTitle}
      ...
      <div className="space-y-3">
        ...
        {lectures.map((lecture, index) => {
          const isCompleted = completedLectures.some(
            (c) => (typeof c === "string" ? c : c._id) === lecture._id,
          );
                ...
                <div className="flex items-center gap-3">
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      navigate(
                        `/course/${courseId}/lecture/${lecture._id}/quiz`,
                      );
                    }}
                    className="bg-purple-600 hover:bg-purple-500 text-white flex items-center gap-2 px-4 py-2 rounded"
                  >
